...
const imageSrc =
  ...
  to the page with JavaScript based on the data given in the 
  `index.js` file.

Use `.innerHTML` to generate the HTML elements for the teaser. 
Use string interpolation to include the given data into 
the HTML.
...
*/
    ...
    <footer class="product__footer">
      ...
      <button type="button" class="product__buy-button" data-js="functional-button">Buy</button>
    </footer>
    `

    document.body.append(newArticle);
    const functionalButton = document.querySelector('[data-js="functional-button"]');
